...
class ProjectStatusTest(unittest.TestCase):
    def test_should_identify_failing_builds(self):
        old_projects = [Project({'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
                                 'lastBuildTime': '2009-05-29T13:54:07'}),
                        Project({'server_url': 'url', 'name': 'proj2', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
                                 'lastBuildTime': '2009-05-29T13:54:37'})]
        new_projects = [Project({'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
                                 'lastBuildTime': '2009-05-29T13:54:07'}),
                        Project({'server_url': 'url', 'name': 'proj2', 'lastBuildStatus': 'Failure', 'activity': 'Sleeping', 'url': 'someurl',
                                 'lastBuildTime': '2009-05-29T13:54:37'})]
    ...
    def test_should_identify_fixed_builds(self):
        old_projects = [Project({'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Failure', 'activity': 'Sleeping', 'url': 'someurl',
                                 'lastBuildTime': '2009-05-29T13:54:07'}),
                        Project({'server_url': 'url', 'name': 'proj2', 'lastBuildStatus': 'Failure', 'activity': 'Sleeping', 'url': 'someurl',
                                 'lastBuildTime': '2009-05-29T13:54:37'})]
        new_projects = [Project({'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
    ...
    def test_should_identify_still_failing_builds(self):
        old_projects = [Project(
            {'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl', 'lastBuildLabel': '1',
             'lastBuildTime': '2009-05-29T13:54:07'}),
            Project(
                {'server_url': 'url', 'name': 'stillfailingbuild', 'lastBuildStatus': 'Failure', 'activity': 'Sleeping', 'url': 'someurl',
                 'lastBuildLabel': '10', 'lastBuildTime': '2009-05-29T13:54:37'})]
        new_projects = [Project(
            {'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl', 'lastBuildLabel': '1',
             'lastBuildTime': '2009-05-29T13:54:07'}),
            Project(
                {'server_url': 'url', 'name': 'stillfailingbuild', 'lastBuildStatus': 'Failure', 'activity': 'Sleeping', 'url': 'someurl',
                 'lastBuildLabel': '11', 'lastBuildTime': '2009-05-29T13:54:47'})]
    ...
    def test_should_identify_still_successful_builds(self):
        old_projects = [Project(
            {'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl', 'lastBuildLabel': '1',
             'lastBuildTime': '2009-05-29T13:54:07'}),
            Project({'server_url': 'url', 'name': 'Successbuild', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
                     'lastBuildLabel': '10', 'lastBuildTime': '2009-05-29T13:54:37'})]
        new_projects = [Project(
            {'server_url': 'url', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl', 'lastBuildLabel': '1',
             'lastBuildTime': '2009-05-29T13:54:07'}),
    ...
    def test_should_build_tuples_by_server_url_and_name(self):
        project_s1 = Project({'server_url': 's1', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
                              'lastBuildTime': '2009-05-29T13:54:07'})
        project_s2 = Project({'server_url': 's2', 'name': 'proj1', 'lastBuildStatus': 'Success', 'activity': 'Sleeping', 'url': 'someurl',
                              'lastBuildTime': '2009-05-29T13:54:07'})
...
def test_should_return_notifications(mocker):
    old_projects = [Project({'server_url': 'url',
                             'name': 'proj1',
                    ...
                    Project({'server_url': 'url',
                             ...
                             'lastBuildLabel': '10',
                             'lastBuildTime': '2009-05-29T13:54:37'})]
    new_projects = [Project({'server_url': 'url',
                             'name': 'proj1',
                             'lastBuildStatus': 'Failure',
                             'activity': 'Sleeping',
                             'url': 'someurl',
